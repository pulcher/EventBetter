...
public static async Task Run(string myQueueItem, ICollector<Result> outTable, TraceWriter log)
{
    ...
    else 
    {
        ...
        statusInfo.PartitionKey = "EventBetter";
        statusInfo.RowKey = Guid.NewGuid().ToString();

        outTable.Add(statusInfo);
